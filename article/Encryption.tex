...
\section{Encryption and Decryption}
  ...
  \subsection{Encrypting a Message}
    ...
    implementing the for loops, 64-bit counter will be necessary due to the
...
\subsection{Decrypting a message}
    ...
    break an encryption algorithim, as the creator can't be threatened
    to break it, as he doesn't know the key. 
\end{document}
